...
Preserve payment/account behavior. Restore interactive globe on /sell using existing local geography and globe renderer. Two explicit price choices, three visual steps, larger readable text and controls. Preserve theme choices and source-photo truthfulness.
